...
namespace DVLDBussinessLayer
{
    public class clsTest
    {
            ...
            public static clsTest Find(int TestID)
        {
            ...
            bool Found = clsTestData.GetTestInfoByID(TestID, ref TestAppointmentID, ref TestResult, ref Notes,
              ref CreatedByUserID);
            if (Found)
            {
          ...
          (int PersonID, int LicenseClassID, clsTestType.enTestType TestTypeID)
        {
            ...
            bool Found = clsTestData.GetLastTestByPersonAndTestTypeAndLicenseClass(PersonID, LicenseClassID, (int)TestTypeID, ref TestID
