...
namespace DVLDPresentationLayer.Applications.Local_Driving_License
{
    public partial class frmAddUpdateLocalDrivingLicesnseApplication : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            int ActiveApplicationID = clsApplication.GetActiveApplicationIDForLicenseClass(__SelectedPersonID, clsApplication.enApplicationType.NewDrivingLicense, LicenseClassID);
